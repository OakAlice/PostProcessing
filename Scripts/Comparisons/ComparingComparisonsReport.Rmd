...
data$smoothing_type <- factor(data$smoothing_type, levels = c("NoSmoothing", "ModeSmoothing", "DurationSmoothing", "TransitionSmoothing", "HMMSmoothing", "BayesianSmoothing", "KalmanSmoothing", "LSTMSmoothing"))
